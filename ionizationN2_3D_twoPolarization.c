/*	
   ...
   eraseLaserField();
   // one or more calls to addLaserField (setting E1_laserField_ionization, E2_laserField_ionization [+ other laser field components])
   finalizeLaserField();
...
double **f6_map_ionization, **f7_map_ionization, **f7_2_map_ionization, **E1_laserField_ionization, **E2_laserField_ionization, **E1_laserFieldLongitudinalComponent_ionization, **E2_laserFieldLongitudinalComponent_ionization; // Nzl_ionization x Nrl_ionization
complex **a_buffer;
...
void finalizeIonization()
{
  ...
  */
  ...
  E1_laserField_ionization=(double**)malloc(Nzl_ionization*sizeof(double*));
  E2_laserField_ionization=(double**)malloc(Nzl_ionization*sizeof(double*));

  E1_laserFieldLongitudinalComponent_ionization=(double**)malloc(Nzl_ionization*sizeof(double*));
  E2_laserFieldLongitudinalComponent_ionization=(double**)malloc(Nzl_ionization*sizeof(double*));
  ...
  for (i=0; i<Nzl_ionization; i++)
    {
      ...
      E1_laserField_ionization[i]=(double*)malloc(Nrl_ionization*sizeof(double));
      E2_laserField_ionization[i]=(double*)malloc(Nrl_ionization*sizeof(double));
      E1_laserFieldLongitudinalComponent_ionization[i]=(double*)malloc(Nrl_ionization*sizeof(double));
      E2_laserFieldLongitudinalComponent_ionization[i]=(double*)malloc(Nrl_ionization*sizeof(double));
...
void eraseLaserField()
{
  ...
  for (i=0; i<Nzl_ionization; i++)
    for (j=0; j<Nrl_ionization; j++)
      {
	E1_laserField_ionization[i][j]=0;
	E2_laserField_ionization[i][j]=0;
	E1_laserFieldLongitudinalComponent_ionization[i][j]=0;
	E2_laserFieldLongitudinalComponent_ionization[i][j]=0;
      }
}
...
void addLaserField(complex **a_laser, double k0_kp_laser, double zmin_laser, double zmax_laser, double rmax_laser, double dz_laser, double dr_laser, int Nz_laser, int Nr_laser, int FLAG_LONG_FIELD, int COMPONENT)
{
  /*
  ...
  */
  ...
  for (i=1; i<Nzl_ionization-1; i++)
	...
	if (COMPONENT==COMPONENT_X)
	  E1_laserField_ionization[i][j]+=creal(buffer+conj(buffer));
	else
	  E2_laserField_ionization[i][j]+=creal(buffer+conj(buffer));
	...
	if (FLAG_LONG_FIELD==YES)
	  {
		...
		if (COMPONENT==COMPONENT_X)
		  E1_laserFieldLongitudinalComponent_ionization[i][j]+=creal(buffer+conj(buffer));
		else		  
		  E2_laserFieldLongitudinalComponent_ionization[i][j]+=creal(buffer+conj(buffer));
	      }
	  }
	else
	  if (j==0)
...
void finalizeLaserField()
{
  ...
  for (i=1; i<Nzl_ionization-1; i++)
    {
      E1_laserField_ionization[i][Nrl_ionization-1]=2*E1_laserField_ionization[i][Nrl_ionization-2]-E1_laserField_ionization[i][Nrl_ionization-3];
      E2_laserField_ionization[i][Nrl_ionization-1]=2*E2_laserField_ionization[i][Nrl_ionization-2]-E2_laserField_ionization[i][Nrl_ionization-3];

      E1_laserFieldLongitudinalComponent_ionization[i][Nrl_ionization-1]=2*E1_laserFieldLongitudinalComponent_ionization[i][Nrl_ionization-2]-E1_laserFieldLongitudinalComponent_ionization[i][Nrl_ionization-3];
      E2_laserFieldLongitudinalComponent_ionization[i][Nrl_ionization-1]=2*E2_laserFieldLongitudinalComponent_ionization[i][Nrl_ionization-2]-E2_laserFieldLongitudinalComponent_ionization[i][Nrl_ionization-3];
    }

  // setting the values in i=0, =Nzl_ionization-1
  for (j=0; j<Nrl_ionization; j++)
    {
      E1_laserField_ionization[0][j]=2*E1_laserField_ionization[1][j]-E1_laserField_ionization[2][j];
      E2_laserField_ionization[0][j]=2*E2_laserField_ionization[1][j]-E2_laserField_ionization[2][j];
      E1_laserFieldLongitudinalComponent_ionization[0][j]=2*E1_laserFieldLongitudinalComponent_ionization[1][j]-E1_laserFieldLongitudinalComponent_ionization[2][j];
      E2_laserFieldLongitudinalComponent_ionization[0][j]=2*E2_laserFieldLongitudinalComponent_ionization[1][j]-E2_laserFieldLongitudinalComponent_ionization[2][j];

      E1_laserField_ionization[Nzl_ionization-1][j]=2*E1_laserField_ionization[Nzl_ionization-2][j]-E1_laserField_ionization[Nzl_ionization-3][j];
      E2_laserField_ionization[Nzl_ionization-1][j]=2*E2_laserField_ionization[Nzl_ionization-2][j]-E2_laserField_ionization[Nzl_ionization-3][j];
      E1_laserFieldLongitudinalComponent_ionization[Nzl_ionization-1][j]=2*E1_laserFieldLongitudinalComponent_ionization[Nzl_ionization-2][j]-E1_laserFieldLongitudinalComponent_ionization[Nzl_ionization-3][j];
      E2_laserFieldLongitudinalComponent_ionization[Nzl_ionization-1][j]=2*E2_laserFieldLongitudinalComponent_ionization[Nzl_ionization-2][j]-E2_laserFieldLongitudinalComponent_ionization[Nzl_ionization-3][j];
    }
}
...
int interpolateIonizedParticle(double *int_Ex, double *int_Ey, double *int_Ez, double *int_Bx, double *int_By, double *int_Bz, double tmp_x, double tmp_y, double tmp_z)
{
  ...
  double r, theta, Ez_w, Er_w, Bphi_w, F1trans_l, F2trans_l, F1long_l, F2long_l;
  ...
  *int_Bz=0;
  ...
  F1trans_l=w00*E1_laserField_ionization[i][j]+w01*E1_laserField_ionization[i][j+1]+w10*E1_laserField_ionization[i+1][j]+w11*E1_laserField_ionization[i+1][j+1];
  F2trans_l=w00*E2_laserField_ionization[i][j]+w01*E2_laserField_ionization[i][j+1]+w10*E2_laserField_ionization[i+1][j]+w11*E2_laserField_ionization[i+1][j+1];

  F1long_l=w00*E1_laserFieldLongitudinalComponent_ionization[i][j]+w01*E1_laserFieldLongitudinalComponent_ionization[i][j+1]+w10*E1_laserFieldLongitudinalComponent_ionization[i+1][j]+w11*E1_laserFieldLongitudinalComponent_ionization[i+1][j+1];
  F2long_l=w00*E2_laserFieldLongitudinalComponent_ionization[i][j]+w01*E2_laserFieldLongitudinalComponent_ionization[i][j+1]+w10*E2_laserFieldLongitudinalComponent_ionization[i+1][j]+w11*E2_laserFieldLongitudinalComponent_ionization[i+1][j+1];
  ...
  *int_Ez+=F1long_l*cos(theta)+F2long_l*sin(theta);
  *int_Bz+=F1long_l*sin(theta)-F2long_l*cos(theta);
...
void ionizationPhysicsDetails_Nitrogen(double *W56, double *W67, double zz, double rr)
{
  ...
  */
  ...
  double n_star, n0_star, l, l_star, Eionization, E1ionization, E2ionization;
  double buf1, buf2;
  ...
  E1ionization=w00*E1_laserField_ionization[ii][jj]+w01*E1_laserField_ionization[ii][jj+1]+w10*E1_laserField_ionization[ii+1][jj]+w11*E1_laserField_ionization[ii+1][jj+1];
  E2ionization=w00*E2_laserField_ionization[ii][jj]+w01*E2_laserField_ionization[ii][jj+1]+w10*E2_laserField_ionization[ii+1][jj]+w11*E2_laserField_ionization[ii+1][jj+1];
  Eionization=hypot(E1ionization, E2ionization);
  
  n0_star=sqrt(U_H/U_N0to1_ionization);
  l_star=n0_star-1;
  l=0; // electrons #5 and #6 are in the 1s orbital (the electrons are in the inner, n=1, shell)
...
void ionizationPhysicsDetails_Krypton(double *W89, double *W910, double zz, double rr)
{
  ...
  */
  ...
  l_star=n0_star-1;
  l=2; // electrons are in the 3d orbitals 
...
void ionizationPhysicsDetails_Argon8to9_10(double *W8_9, double *W9_10, double zz, double rr)
{
  ...
  */
  ...
  l_star=n0_star-1;
  l=1; // electrons are in the 2p orbital 
